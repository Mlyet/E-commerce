...
const Header = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const result = (
                <div className="bg-red-700 h-64 no-scrollbar overflow-y-scroll w-9/12">
                    {filter.map((item) => {
                        return (
                            <Fragment key={item.id}>
                                <div
                                    ...
                                    className="w-full w-min-full bg-red flex m-auto hover:bg-red-50"
                                >
                    ...
                    <div className="text-right">
                        <div className="flex items-center space-x-2">
                            ...
                            <span
                                ...
                                onClick={() => handleDropdownClick()}
                            >
                                {user.email ? user.name : "Mon profil"}
                            </span>
                        </div>
                    </div>
                </div>
