    ...
    return (
        ...
        <HeaderRegister />
            ...
            <div className="bg-[url('ugly.png')] bg-cover h-4/5  bg-no-repeat bg-center flex m-auto" style = {{width: "86vw"}}>
                    ...
                    <div className="bg-[#1818189a] lg:m-0 m-auto h-screen backdrop-blur-sm xxs:w-auto xxs:h-min xxs:mt-50 lg:w-1/2 lg:h-screen lg:mt-0 lg:ml-0">
                        <div className="rounded-md">
                            <div className="flex flex-col w-60 mx-10">
                                <h1 className="mt-10 lg:mt-72 text-white">
                                    Email
                                </h1>
                                <input
